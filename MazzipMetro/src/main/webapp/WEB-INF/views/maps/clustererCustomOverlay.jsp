...
<div id="searchFrmContainer">
	<form id="searchFrm">
		...
		<br/> 
		<label class="radio-inline"><input type="radio" name="restManager" value="0">관리자 관할 음식점</label>
		<label class="radio-inline"><input type="radio" name="restManager" value="1">업주관리 음식점</label><!-- userSeq가 관리자가 아닌 매장 -->
		<br/> 
	</form>
</div>
<br/> 
...
<script>
	...
	function goMap(){
		var srchFrmData{
			srchType :
		  , restBgTage :
		  , restManager : $("[name=restManager]").val();
				
		}
		
		var map = new daum.maps.Map(document.getElementById('map'), { // 지도를 표시할 div
	        center : new daum.maps.LatLng(37.553042, 126.981990), // 지도의 중심좌표 
	        level : 11// 지도의 확대 레벨 
	    });
