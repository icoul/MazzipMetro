...
.subleftCon {float:left; width:200px; height:auto; border-left:1px solid #dbdbdb; border-right:1px solid #dbdbdb; padding:0; margin:0;}
...
.tblUserList {border-collapse: collapse; width:1000px; text-aign:center;}
