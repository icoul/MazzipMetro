...
<body>
	...
	<div>
		...
		<tr><th>업장 대표이미지  :	 		</th><td id="addImg"><img src="<%=request.getContextPath()%>/files/${vo.restImg}" id="currImg" width="300px;"><br/><br/><input type='file' id="attach" name="attach" /></td></tr>
