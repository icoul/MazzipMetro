	...
	$(document).ready(function(){
		...
		$("#menuNum").change(function(){
			...
			for (var i = count; i < menuNum; i++) {
					...
					html += "</tr>"
					html += "<tr class = 'tr'>"
						html += "<td width='80px' style = 'font-size : 11pt;'><b>메뉴명</b></td>"
						html += "<td width='40px' class = 'lcontent' align='left'>"
							html += "<input type='text' class=\"menuName"+i+"\" name=\"menuName\" id=\"menuName"+i+"\" value=\"\" /></td>"
						html += "<td width='100px' style = 'font-size : 11pt;'><b>한 줄 설명</b></td>"
						html += "<td width='40px' class = 'rcontent' align='left' colspan = '3'>"
