                    ...
                    <div class="tab-pane active" role="tabpanel" id="step1">
                        <div class="step1">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" class="form-control" id="userEmail" placeholder="사용자 이메일">
                            </div>
                            <div class="col-md-3">
                                <label for="exampleInputEmail1">이메일확인</label>
                                <input type="email" class="form-control" id="userEmail_confirm" placeholder="이메일 확인">
                            </div>
                            <div class="col-md-3">
                                <label for="exampleInputEmail1">비밀번호</label>
                                <input type="email" class="form-control" id="userPw" placeholder="비밀번호 입력">
                            </div>
                            <div class="col-md-3">
                                <label for="exampleInputEmail1">비밀번호확인</label>
                                <input type="email" class="form-control" id="userPw_confirm" placeholder="비밀번호 확인">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputEmail1">이름</label>
                                <input type="email" class="form-control" id="userName" placeholder="사용자 이름">
                            </div>
                            <div class="col-md-6">
                                <label for="exampleInputEmail1">생년월일</label><br>
	                        ...
	                        <div class="row">
	                            <div class="col-md-6">
	                                ...
	                                <div class="col-sm-6">
				                        <!-- <div class="row">
				                            <div class="col-sm-4">
				                                    <input type="radio" id="femaleRadio" value="Female">남
				                            </div>
				                            <div class="col-sm-4">
				                                <label class="radio-inline">
				                                    <input type="radio" id="maleRadio" value="Male">여
				                                </label>
				                            </div>
				                        </div> -->
...
<div class="form-group">
              ...
              <div class="col-lg-8">
                ...
                <div id="upload-avatar" class="upload-avatar">
                  <div class="userpic" style="background-image: url('https://secure.gravatar.com/avatar/b3744389dcc0c2a9f2342f052683f20a?s=100&amp;r=g&amp;d=mm');">
...
이용약관 및 개인정보 수집 및 이용에 모두 동의합니다. <input type="checkbox"> <br>
이용약관 동의 (필수) 약관보기 <input type="checkbox"> <br>
개인정보 수집 및 이용 동의 (필수) 약관보기 <input type="checkbox"> <p>
...
비밀번호 <input type="password"> <i class="fa fa-file"></i> <br>
사용불가(안전도 등급 매우 약함)
사용가능(안전도 등급 낮음)
<br>
안전한 비밀번호 작성법 <p>
1. 6~16자의 영문 대소문, 숫자, 특수기호만 사용가능 (공백입력 불가)<br>
2. 비밀번호는 주기적으로 변경하여 안전하게 관리하기 <br>

성별 남 <input type="radio"> 여 <input type="radio">

<hr>
개인 맞춤 채용정보/정기 뉴스레터/이벤트 메일이 발송됩니다. <br>
