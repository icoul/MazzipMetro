...
<!-- Frm : db에 음식점 insert하기 -->
<form name="addRestaurantFrm" action="addRestaurant.action" method="post">
	<input type="hidden" name="restaurantTitle" id="restaurantTitle"/>
	<input type="hidden" name="newAddr" id="newAddr"/>
	<input type="hidden" name="addr" id="addr"/>
	<input type="hidden" name="phone" id="phone"/>
	<input type="hidden" name="latitude" id="latitude"/>
	<input type="hidden" name="longitude" id="longitude"/>
	<input type="hidden" name="metroId" id="metroId"/>
...
function displayPlaces(places) {
    ...
    }//end of for ( var i=0; i<places.length; i++ ) 
...
function getListItem(index, places) {
    ...
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                '<div class="info">' +
                '   <h5><a href="http://naver.com">' + places.title + '</a></h5>';
    ...
    if (places.newAddress) {
      ...
      itemStr += '  <a href="tel:'+places.phone+'"><span class="tel">' + places.phone  + '</a></span>' +
                '</div>';           
...
function displayInfowindow(marker, title) {
    var content = '<div class="infoTitle" style="padding:5px;z-index:1;">' + title + '</div>';
...
// db에 음식점 insert 하기
function mySubmit(){
	var restaurantDataFrm = {
			restaurantTitle : $("#restaurantTitle").val()
		  , newAddr : $("#newAddr").val()
		  , addr : $("#addr").val()
		  , phone : $("#phone").val()
...
//지하철역id얻어오기
function getMetroId(keyword){
	
	var pos = keyword.indexOf(" ")
	var metroName = keyword.substring(0,pos);
