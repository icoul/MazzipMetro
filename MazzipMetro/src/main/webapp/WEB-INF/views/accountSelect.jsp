...
<a href="<%= request.getContextPath()%>/userRegister.eat" class="btn btn-sq-lg btn-info">
              <i style="font-size: 10em;" class="fa fa-user"></i><br><br>
              	<span style="font-size:2em;">개인</span>
            </a>
            
<a href="<%= request.getContextPath()%>/restRegister.eat" class="btn btn-sq-lg btn-success">
              <i style="font-size: 10em;" class="fa fa-user"></i><br><br>
