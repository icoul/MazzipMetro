...
<c:forEach var="list" items="${mapList}" begin="0" end="4" >
			<td style = "padding:20px 5px 5px;">
				<a href="<%=request.getContextPath()%>/restaurantDetail.eat?restSeq=${list.restSeq}"><img width = "120px;" height="120px;" src="<%= request.getContextPath() %>/files/rest/${list.restImg}" /></a><br/>
